    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "Abc123.", "Inbuilt Administrator", "hoanganh727018@gmail.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "Abc123.", "Inbuilt Standard User", "hoang.anh727018@gmail.com", "+1 (123) 000-0001", new string[] { userRoleName });
